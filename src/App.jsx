        ...
        <div className="header">
          ...
          <div className="saved">
            ...
            <p>You Saved</p>
              ...
              <Button id='bott'  className='btn' style={{backgroundColor:"black"}} variant="contained" onClick={e=>Calculate(e)}>Calculate</Button> 
              <Button id='butt' className='btn' style={{backgroundColor:"grey",color:"black"}} variant="outlined" onClick={e=>reset(e)}>Reset</Button>
              </div>
